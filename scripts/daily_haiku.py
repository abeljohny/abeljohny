...
def format_as_csv_rows(haikus, stats, means, win_idx, file_exists):
...
def update_history(haikus, stats, means, win_idx):
...
if __name__ == "__main__":
    ...
    update_history(haikus, haikus_rated_list, haikus_rated_avgs, winning_haiku_idx)
